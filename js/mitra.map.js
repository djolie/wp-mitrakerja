...
function setByLatLongChecked(){
    jQuery("#byLatLong").attr('checked','checked');
}
function initAlamatLembaga() {
    geocoder = new google.maps.Geocoder();
    var latlng = new google.maps.LatLng(-6.589166, 106.79299900000001);// lat long -> Bogor
    var myOptions = {
      zoom: 8,
      center: latlng,
...
function petaAlamatLembaga(status) {
    var latlong = '';
